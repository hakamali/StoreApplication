...
import 'package:storeappfirebase/Data.dart';
import 'package:storeappfirebase/LogInScreen.dart';
import 'package:image_picker/image_picker.dart';
import 'package:storeappfirebase/MyFavorite.dart';
import 'package:storeappfirebase/UploadData.dart';
...
//           key is the upload id
    ...
    return Scaffold(
          ...
          children: <Widget>[
            Container(
              ...
              children: <Widget>[
                ...
                Image(image: AssetImage("images/sslogo.png"),height: 90,width: 90,),
                SizedBox(height: 10,),
      ...
      body: dataList.length == 0 ? Center(child: Text("No Data Available",style:TextStyle(fontSize: 30) ,)): ListView.builder(
        itemCount: dataList.length,
          itemBuilder: (_,index){
              return CardUI(dataList[index].imageUrl,dataList[index].name,
  ...
  Widget CardUI(String imageUrl, String name, String material, String price,String uploadId,int index) {
    return Card(
      elevation: 7,
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              width: double.infinity,
              child: Text(price,style: TextStyle(color: Colors.red,fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.right,),
            ),
            SizedBox(height: 1,),
            favList[index]?
