...
import 'package:storeappfirebase/HomeScreen.dart';
...
class _SignUpScreen extends State<SignUpScreen>{
  ...
  Future<void> register() async{
   await auth.createUserWithEmailAndPassword(
      ...
      Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>HomeScreen(value.user.email)
      ));
     ...
     child: ListView(
        ...
        children: <Widget>[
          ...
          Theme(
            ...
            child:
            Padding(padding: EdgeInsets.only(top: 50,right: 20,left: 20),
              child: TextFormField(
                validator: (value){
                  if(value.isEmpty){
