         ...
         children: <Widget>[
           ...
           Row(
             children: <Widget>[
               ...
               Expanded(
                 flex: 1,
                 child: Theme(data: ThemeData( hintColor: Colors.blue),
                     child: TextFormField(
                    validator: (value){
                     if(value.isEmpty){
                       return "Please write the name of the production";
                     }else{
                         name=value;
                     }
                    },
               ...
               Expanded(
                 ...
                 child: Theme(data: ThemeData( hintColor: Colors.blue),
                   child: TextFormField(
                     validator: (value){
                       if(value.isEmpty){
                         return "Please write the material of the production";
                       }else{
                         material=value;
                       }
                     },
               ...
               Expanded(
                 ...
                 child: Theme(data: ThemeData( hintColor: Colors.blue),
                   child: TextFormField(
                     validator: (value){
                       if(value.isEmpty){
                         return "Please write the price  of the production";
                       }else{
                         price=value;
                       }
                     },
